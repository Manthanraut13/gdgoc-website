    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={contentRef} className="text-center lg:text-left">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-2xl px-4 py-2 shadow-soft mb-8">
              ...
              <span className="text-sm font-medium text-dark-gray">Welcome to GDG On-Campus</span>
            </div>

            <h1 className="hero-title text-5xl md:text-6xl lg:text-7xl font-poppins font-bold text-dark-gray mb-6 leading-tight">
              <span className="block bg-gradient-to-r from-dark-gray to-gdg-blue bg-clip-text text-transparent">
                Google Developer
              </span>
              <span className="block bg-gradient-to-r from-gdg-blue to-gdg-red bg-clip-text text-transparent">
                Group On-Campus
              </span>
            </h1>
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-large p-8 border border-white/20">
                ...
                <div className="bg-gradient-to-r from-gdg-blue to-blue-600 rounded-2xl p-6 text-white text-center">
                  ...
                  <div className="text-sm text-blue-200 mt-2">Jan 15, 2024 • 2:00 PM</div>
                </div>
              </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="w-6 h-10 border-2 border-gray-300 rounded-full flex justify-center">
          <div className="w-1 h-3 bg-gdg-blue rounded-full mt-2 animate-bounce"></div>
        </div>
      </div> */}
    </section>
  );
